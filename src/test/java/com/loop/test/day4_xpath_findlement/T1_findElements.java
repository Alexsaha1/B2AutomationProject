...
public class T1_findElements {
    public static <List> void main(String[] args) {
        ...
        java.util.List<WebElement> nbaLinks = driver.findElements(By.tagName("a"));
        System.out.println(((java.util.List<?>) nbaLinks).size());

        java.util.List<WebElement> nbaLinkXpath = driver.findElements(By.xpath("//a"));
        System.out.println("nbaLinkXpath.size() = " + ((java.util.List<?>) nbaLinkXpath).size());
